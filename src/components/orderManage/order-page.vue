 ...
 * @LastEditTime: 2019-04-09 14:19:26
 -->
<template>
  <div class="order-confirmation">
    ...
    <div>
      ...
      <div class="address-manage">
        ...
        <!-- <AddAddress @submitorder="handleSubmitOrder"></AddAddress> -->
...
<script>
  ...
  import AddAddress from '../addressMange/addAddress';
  import AddressBox from '../addressMange/userAddress';
  import { GET_ORDER_ADDRESS_INFO,PLACE_ORDER } from '../../api/pageDataApis';
  import SelectAddress from '../addressMange/select-address';
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit() {
        PLACE_ORDER(Object.assign({}, {
          bid: this.$route.query.id,
          type: this.type
        }, this.defaultAddress)).then(Response => {
      ...
      ... mapActions('moduleAddress',['setDefaultAddress', 'setShippingAddress'])
    },
    computed: {
